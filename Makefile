...
# Import database
importdb:
	docker exec -i postgres-db psql -U root -d homestay < ./backupdb-master-golang.sql

# Export database
exportdb:
	docker exec -i postgres-db pg_dump -U root -d homestay > ./backupdb-master-golang.sql
